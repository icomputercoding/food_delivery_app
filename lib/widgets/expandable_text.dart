...
class _ExpandableTextState extends State<ExpandableText> {
  ...
  double textHeight = Dimensions.screenHeight / 5.71;
  ...
  Widget build(BuildContext context) {
    return Container(
      child: secondHalf.isEmpty?SmallText(text: firstHalf,size: Dimensions.font16,):Column(
        children: [
          SmallText(color: AppColors.paraColo,height: 1.8,text: hiddenText?("$firstHalf..."):(firstHalf+secondHalf),size: Dimensions.font16,),
          InkWell(
              onTap: () {
                setState(() {
